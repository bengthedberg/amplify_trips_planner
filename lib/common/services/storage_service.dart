...
// In this service, you will find the uploadFile function that uses the Amplify
// storage library to upload an image into an Amazon S3 bucket.
// Additionally, the service provides a ValueNotifier object to track the
